...
static u32 _inic_ipc_ip_addr_update_in_wowlan(u32 expected_idle_time, void *param)
{
	...
	ipc_send_message(IPC_DIR_MSG_TX, IPC_H2D_WIFI_API_TRAN, &g_host_ipc_api_msg);
...
IPC_TABLE_DATA_SECTION const IPC_INIT_TABLE ipc_api_host_table[] = {

...
//  	Module							Group				Msk_NP				Msk_AP				Msk_DSP
	...
	{WAKE_SRC_Timer7,						0,					OFF,				ON,			OFF},
	{WAKE_SRC_Timer6,						0,					OFF,				ON,				OFF},
	{WAKE_SRC_Timer5,						0,					OFF,				ON,				OFF},
	{WAKE_SRC_Timer4,						0,					OFF,				ON,			OFF},
	{WAKE_SRC_Timer3,						0,					OFF,				ON,				OFF},
	{WAKE_SRC_Timer2,						0,					OFF,				ON,				OFF},
	{WAKE_SRC_Timer1,						0,					OFF,				ON,				OFF},
	{WAKE_SRC_Timer0,						0,					OFF,				ON,				OFF},
